...
let favoriteFoods = ['tacos', 'enchildas verdes', 'pizza'];
...
let dessert = " red velvet cake";
favoriteFoods.push(dessert);
console.log('adding fav dessert', favoriteFoods);
...
let entree = 'breaded chicken';
favoriteFoods.unshift(entree);
console.log('Added entree', entree);
...
console.log('The last color is', colors);
